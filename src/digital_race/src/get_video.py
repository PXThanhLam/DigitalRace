...
depth_subcriber=rospy.Subscriber("/team1/camera/rgb/compressed", CompressedImage, depth_image_callback)
out = cv2.VideoWriter('outputdepth.avi',cv2.VideoWriter_fourcc('M','J','P','G'), 30, (320,240))
rospy.spin()
